...
public  class Serializer extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor_haxe_Serializer(haxe.Serializer __temp_me10)
	{
		__temp_me10.buf = new haxe.root.StringBuf();
		__temp_me10.cache = new haxe.root.Array();
		__temp_me10.useCache = haxe.Serializer.USE_CACHE;
		__temp_me10.useEnumIndex = haxe.Serializer.USE_ENUM_INDEX;
		__temp_me10.shash = new haxe.ds.StringMap<java.lang.Object>();
		__temp_me10.scount = 0;
	}
			...
			switch (haxe.root.Type.enumIndex(_g))
			{
				...
				case 6:
				{
					java.lang.Class c = ((java.lang.Class) (_g.params.__get(0)) );
					{
						...
						{
							java.lang.Class __temp_switch83 = (c);
							if (haxe.lang.Runtime.eq(__temp_switch83, haxe.root.Array.class)) 
							{
								int ucount = 0;
								this.buf.add("a");
							...
							{
								if (haxe.lang.Runtime.eq(__temp_switch83, haxe.root.List.class)) 
								{
									this.buf.add("l");
									haxe.root.List v1 = ((haxe.root.List) (v) );
									{
										java.lang.Object __temp_iterator40 = v1.iterator();
										while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator40, "hasNext", null)))
										{
											java.lang.Object i = ((java.lang.Object) (haxe.lang.Runtime.callField(__temp_iterator40, "next", null)) );
											this.serialize(i);
										}
								...
								{
									if (haxe.lang.Runtime.eq(__temp_switch83, haxe.root.Date.class)) 
									{
									...
									{
										if (haxe.lang.Runtime.eq(__temp_switch83, haxe.ds.StringMap.class)) 
										{
											this.buf.add("b");
											haxe.ds.StringMap v1 = ((haxe.ds.StringMap) (v) );
											{
												java.lang.Object __temp_iterator41 = v1.keys();
												while (haxe.lang.Runtime.toBool(haxe.lang.Runtime.callField(__temp_iterator41, "hasNext", null)))
												{
													java.lang.String k = haxe.lang.Runtime.toString(haxe.lang.Runtime.callField(__temp_iterator41, "next", null));
										...
										{
											if (haxe.lang.Runtime.eq(__temp_switch83, haxe.ds.IntMap.class)) 
											{
												this.buf.add("q");
												haxe.ds.IntMap v1 = ((haxe.ds.IntMap) (v) );
												{
													...
													{
														int k = ((int) (haxe.lang.Runtime.toInt(haxe.lang.Runtime.callField(__temp_iterator42, "next", null))) );
														this.buf.add(":");
														this.buf.add(k);
														this.serialize(v1.get(k));
													}
											...
											{
												if (haxe.lang.Runtime.eq(__temp_switch83, haxe.ds.ObjectMap.class)) 
												{
													this.buf.add("M");
													haxe.ds.ObjectMap v1 = ((haxe.ds.ObjectMap) (v) );
													{
														...
														{
															java.lang.Object k = ((java.lang.Object) (haxe.lang.Runtime.callField(__temp_iterator43, "next", null)) );
															this.serialize(k);
															this.serialize(v1.get(k));
														}
												...
												{
													if (haxe.lang.Runtime.eq(__temp_switch83, haxe.io.Bytes.class)) 
													{
