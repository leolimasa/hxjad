...
public  class Type extends haxe.lang.HxObject
{
	...
	public static   java.lang.String getClassName(java.lang.Class c)
	{
		...
		{
			java.lang.String __temp_svar81 = (name);
			boolean __temp_executeDef82 = true;
			switch (__temp_svar81.hashCode())
			{
				case 104431:
				{
					if (__temp_svar81.equals("int")) 
					{
				...
				case -1939501217:
				{
					if (__temp_svar81.equals("Object")) 
					{
						__temp_executeDef82 = false;
						return "Dynamic";
					}
				...
				case -672261858:
				{
					if (__temp_svar81.equals("Integer")) 
					{
						__temp_executeDef82 = false;
						return "Int";
					}
				...
				case 2052876273:
				{
					if (__temp_svar81.equals("Double")) 
					{
						__temp_executeDef82 = false;
						return "Float";
					}
