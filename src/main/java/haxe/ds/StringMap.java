...
public  class StringMap<T> extends haxe.lang.HxObject implements haxe.root.IMap<java.lang.String, T>
{
	...
	public   void set(java.lang.String key, T value)
	{
		...
		int[] hashes1 = hashes;
		{
			 ...
			 else 
			{
				...
				do 
				{
					boolean __temp_stmt152 = false;
					{
						int v = flag = hashes1[i];
						__temp_stmt152 = ( (( v & -2 )) == 0 );
					}
					
					boolean __temp_boolv153 = false;
					if ( ! (__temp_stmt152) ) 
					{
						__temp_boolv153 = ( ( flag == k ) && haxe.lang.Runtime.valEq(this._keys[i], key) );
					}
					
					boolean __temp_stmt151 = ( __temp_stmt152 || __temp_boolv153 );
					if ( ! ((__temp_stmt151)) ) 
					{
						i = ( ( i +  ++ nProbes ) & mask );
					}
	...
	public   int lookup(java.lang.String key)
	{
		if (( this.nBuckets != 0 )) 
		{
			...
			do 
			{
				boolean __temp_stmt157 = false;
				{
					int v = flag = hashes[i];
					__temp_stmt157 = ( v == 0 );
				}
				
				boolean __temp_boolv156 =  ! (__temp_stmt157) ;
				boolean __temp_boolv155 = false;
				if (__temp_boolv156) 
				{
					__temp_boolv155 = (( ( ( flag == 1 ) || ( flag != k ) ) ||  ! (haxe.lang.Runtime.valEq(keys[i], key))  ));
				}
				
				boolean __temp_stmt154 = ( __temp_boolv156 && __temp_boolv155 );
				if (__temp_stmt154) 
				{
					i = ( ( i +  ++ nProbes ) & mask );
				}
	...
	public   void resize(int newNBuckets)
	{
		...
		if (( j != 0 )) 
		{
			...
			{
				int k = 0;
				boolean __temp_stmt158 = false;
				{
					int v = k = hashes[j];
					__temp_stmt158 = ( (( v & -2 )) == 0 );
				}
				...
				if ( ! (__temp_stmt158) ) 
				{
					...
					while (true)
					{
						...
						newHash[i] = k;
						boolean __temp_boolv161 = ( i < nBuckets );
						boolean __temp_boolv160 = false;
						if (__temp_boolv161) 
						{
							boolean __temp_stmt162 = false;
							{
								int v = k = hashes[i];
								__temp_stmt162 = ( (( v & -2 )) == 0 );
							}
							
							__temp_boolv160 =  ! (__temp_stmt162) ;
						}
						
						boolean __temp_stmt159 = ( __temp_boolv161 && __temp_boolv160 );
						if (__temp_stmt159) 
						{
							{
	...
	public   java.lang.Object keys()
	{
		...
		{
			haxe.lang.Function __temp_odecl163 = new haxe.ds.StringMap_keys_356__Fun<T>(((haxe.root.Array<java.lang.Object>) (i) ), ((haxe.root.Array<haxe.ds.StringMap>) (_g1) ), ((haxe.root.Array<java.lang.Object>) (len) ));
			haxe.lang.Function __temp_odecl164 = new haxe.ds.StringMap_keys_367__Fun<T>(((haxe.root.Array<java.lang.Object>) (i) ), ((haxe.root.Array<haxe.ds.StringMap>) (_g1) ));
			return new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"hasNext", "next"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl163, __temp_odecl164}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
